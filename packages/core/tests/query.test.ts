...
describe('query', () => {
  ...
  it('tie-breaks by lower ID first (string lexicographic)', () => {
    const instance = create({ dimensions: 2, metric: 'dot' });
  ...
  it('tie-breaks by lower ID first (bigint numeric)', () => {
    const instance = create({ dimensions: 2, metric: 'dot' });
  ...
  it('works with INT8 quantization', () => {
  ...
  it('works with BIT quantization and hamming metric', () => {
